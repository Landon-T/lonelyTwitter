...
public class IntentReaderActivityTest extends ActivityInstrumentationTestCase2{
    ...
    public void testDoubleText(){
        ...
        assertEquals("The text should be doubled", "message 3message 3", ira.getText());
...
//-------------------------------------------------------------------------------
    public void testReverse(){
        ...
        assertEquals("should be reversed", "4 egassem", ira.getText());
    ...
    public void testDefault(){
        ...
        assertEquals("should be the default", "default text", ira.getText());
    }
